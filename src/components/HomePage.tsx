...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <header className="border-b border-[#232323] bg-[#111111]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Aperçu des produits</h2>
          ...
          <div className="text-center mt-8">
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-[#ff0033] to-[#cc0029] text-white px-8 py-4 rounded-lg font-semibold hover:from-[#cc0029] hover:to-[#990022] transition-all duration-200"
            >
      ...
      {/* Footer */}
      <footer className="border-t border-[#232323] bg-[#111111] mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-400">
            <p>&copy; 2025 DropSkills. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>

      ...
      <div className="min-h-screen">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="fixed bottom-4 right-4 z-50">
            <Link
              href="/dev-login"
              className="bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white px-3 py-2 rounded-lg text-xs flex items-center gap-2 transition-all duration-200 border border-gray-600 hover:border-gray-500 shadow-lg"
              title="Connexion développement"
            >

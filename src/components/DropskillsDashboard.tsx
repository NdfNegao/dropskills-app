  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex">
      ...
      <aside className="w-64 bg-neutral-900 p-6 flex flex-col gap-4 border-r border-neutral-800">
        ...
        <button className="mt-6 bg-gradient-to-r from-sky-600 to-violet-700 py-2 rounded-xl shadow text-white font-semibold hover:scale-105 transition">🚀 Passer en Premium</button>
      </aside>
      {/* Main Content */}
      <main className="flex-1 p-10">
        ...
        <header className="mb-10">
          ...
          <div className="flex gap-4">
            <button className="bg-sky-600 hover:bg-sky-700 transition rounded-xl px-6 py-3 font-bold text-lg">Essayer un pack gratuit</button>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-neutral-900 rounded-2xl p-6 shadow flex flex-col gap-2 border border-neutral-800 relative group hover:shadow-lg hover:border-sky-600 transition">
                <span className="absolute right-4 top-4 bg-sky-600 px-2 py-1 rounded text-xs font-semibold uppercase tracking-wider">{pack.badge}</span>
                <h3 className="text-xl font-bold mb-1">{pack.title}</h3>
                <p className="text-neutral-300 mb-4">{pack.desc}</p>
                <div className="flex gap-3 mt-auto">
                  <button className="bg-sky-600 px-4 py-2 rounded-lg text-white font-semibold hover:bg-sky-700">Ouvrir</button>
                  ...
                  <button className="ml-auto text-sky-400 hover:text-sky-200"><span role="img" aria-label="Favoris">⭐</span></button>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <blockquote className="bg-neutral-900 rounded-xl p-6 border-l-4 border-sky-600 text-neutral-200 shadow">“Dropskills m’a permis de vendre ma première formation en 48h, sans galère !”</blockquote>
            <blockquote className="bg-neutral-900 rounded-xl p-6 border-l-4 border-sky-600 text-neutral-200 shadow">“Le support WhatsApp m’a vraiment aidé à débloquer mes premiers clients.”</blockquote>
            <blockquote className="bg-neutral-900 rounded-xl p-6 border-l-4 border-sky-600 text-neutral-200 shadow">“Enfin une vraie communauté, pas juste des vendeurs de rêve !”</blockquote>
          </div>
        </section>
        {/* FAQ & Support */}
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-3">
              <button className="bg-sky-600 px-4 py-3 rounded-xl text-white font-bold hover:bg-sky-700">Parler à un expert</button>
